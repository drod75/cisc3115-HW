...
public class Account {
	...
	*/
	...
	public boolean equals(Account account) {
		if(info.equals(account.info) && acctType.equals(account.acctType) ) return true;
		else return false;
	}
	...
	public String toString() {
		...
		String toStr = String.format("%-12s%-12s%-9s %8d\t\t\t%-9s\t\t$%8.2f\t" + date, info.getName().getLast(), info.getName().getFirst(),
				info.getSSN(), acctNumber, acctType, balance);
		return toStr;
	}
