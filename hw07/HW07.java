	...
	public static int readAccts(Bank bank) throws FileNotFoundException {
		...
		while (readFrom.hasNext()) {
			...
			if (type.equals("Savings")){
				fillUp = new SavingsAccount(depositer, accountNumber, type, balance, true);
			}else if (type.equals("Checking")){
				fillUp = new CheckingAccount(depositer, accountNumber, type, balance, true);
			}else if (type.equals("CD")){
				fillUp = new CDAccount(depositer, accountNumber, type, balance, true, date);
			}			
